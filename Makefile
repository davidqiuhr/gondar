...
GOOGLE_SIGN_IN_SECRET_HEX1 ?= ""
GOOGLE_SIGN_IN_SECRET_HEX2 ?= ""
RELEASE ?= false
...
build-gondar: print-config update-submodules
	...
	cd ${BUILD_DIR} && \
		${CMAKE} .. \
			...
			-DGOOGLE_SIGN_IN_SECRET_HASH1:STRING=${GOOGLE_SIGN_IN_SECRET_HASH1} \
			-DGOOGLE_SIGN_IN_SECRET_HASH2:STRING=${GOOGLE_SIGN_IN_SECRET_HASH2} \
			-DRELEASE=${RELEASE} && \
		make -j
